List<string> frutas = new() {"pera","melon","sandia","durazno","manzana","platano","kiwi","naranja","jicama","piña","papaya","limas","moras","lichis","guamuchiles","chilitos","pitayas","mango","xoconoztle"};
...
Console.WriteLine("\nFrutas que contienen las letras xz " + xz.Count());
